<?php include 'partials/header-cc-brand.php'; ?>
        ...
        <div class="container container--retain-padding">
            ...
            <nav class="ms-menu">
                <ul class="ms-menu__list">
                    ...
                    <li><a href="minisite-cc-weddings.php">Weddings</a></li>
                    <li><a href="#">Spa</a></li>
            ...
            <div class="ms-content pt pt--small">
                ...
                <p>As well as all of Harrogate’s wonderful visitor attractions, the St George Hotel is also perfectly
                    placed
                    for days out in the Yorkshire Dales, so do bring your walking boots and get ready for fresh air and
                    some
...
<?php include 'partials/footer-cc.php'; ?>